  ...
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <span className="px-4 py-2 rounded-full bg-brand/20 border border-brand text-brand backdrop-blur-sm">
        ...
        >
          Cook, Share &
          <span className="block bg-linear-to-r from-brand via-brand-strong to-warning bg-clip-text text-transparent">
        ...
        >
          <Link href="/recipes">
            <button className="group px-8 py-4 rounded-full bg-accent hover:bg-accent-hover text-accent-foreground font-semibold transition-all duration-300 flex items-center gap-3 shadow-xl">
              Explore Recipes
        ...
        >
          <div>
            <h3 className="text-3xl font-bold text-brand">500+</h3>
            <p className="text-gray-300 text-sm">Recipes</p>
          </div>

          <div>
            <h3 className="text-3xl font-bold text-brand">1K+</h3>
